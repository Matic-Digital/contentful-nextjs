 ...
 */
export default async function PageListPreviewPage({ params, searchParams }: PageListPreviewPageProps) {
          ...
          <div className="flex">
            ...
            <div className="ml-3 flex-1">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>You are viewing the PageList component in preview mode. {isDraftMode ? 'Draft mode is enabled.' : 'Draft mode is disabled.'}</p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>Please provide a page list slug in the URL query parameters (e.g., ?pageListSlug=your-page-list-slug).</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-md bg-yellow-50 p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>No page list data was found for slug: {pageListSlug}. Make sure the slug exists in Contentful.</p>
                </div>
              </div>
            </div>
          </div>

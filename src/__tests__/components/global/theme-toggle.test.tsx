...
vi.mock('@/components/ui/button', () => ({
  Button: vi.fn().mockImplementation((props: React.ButtonHTMLAttributes<HTMLButtonElement> & { className?: string, children?: React.ReactNode }) => (
    <button className={props.className} data-testid="theme-button">{props.children}</button>
  )),
}));
